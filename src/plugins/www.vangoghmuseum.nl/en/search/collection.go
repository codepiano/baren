...
func getPaintingInfo(doc *goquery.Document) ([]string, error) {
	// 获取图片地址
	...
	return []string{Domain + largePicUrl, info[0], fileName + fileExtension, paintingAddress, paintingIntroduce}, nil
}

func (plugin) Baren(body io.Reader, loader func(string) io.ReadCloser, c chan []string) {
